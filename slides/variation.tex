...
\begin{frame}[c]{FocusP: Gungbe}
    ...
    \begin{exe}
        \exi{(3)} Gungbe (adapted from Aboh 2007: 85(9c))
...
\begin{frame}[c]{FocusP: Standard Italian}
    ...
    \begin{exe}
            \exi{(4)} Italian (adapted from \cite{samo2019cartography}: 146 (8))
...
\begin{frame}[c]{FocusP: German}
        ...
        \begin{exe}
            \exi{(5)}	German (adapted from \cite{samo2019cartography}: 146 (8))
