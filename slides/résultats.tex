...
\begin{frame}[c]{Towards predominant non-movement/activation}
    ...
    \textbf{\textsc{the decline of vs}}
    \begin{center}
        \includegraphics[width=10cm, height=6cm]{images/exsituinsitu0.png}
    \end{center}
...
\begin{frame}[c]{Towards predominant non-movement/activation}
    ...
    \textbf{\textsc{the decline of vs}}
    \begin{center}
        \includegraphics[width=10cm, height=6cm]{images/exsituinsitu1.png}
    \end{center}
...
\begin{frame}[c]{Towards predominant non-movement/activation}
    ...
    \textbf{\textsc{the decline of vs}}
    \begin{center}
        \includegraphics[width=10cm, height=6cm]{images/exsituinsitu2.png}
    \end{center}
...
\begin{center}
    \textbf{Third change\\From est-ce que to SV}
\end{center}
  
\end{frame}
%   FRAME END   --==-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
%   FRAME START   -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
\begin{frame}[c]{Towards predominant non-activation of the head}

    \transboxin<1>
    \transglitter<2>
    %\transwipe<3>
    \textbf{\textsc{our raw data}} \pause
...
\begin{table}[H]
    ...
    \large
        ...
        \hline
        \end{tabular}
\caption{\label{tab:samp8}Total occurrences of est-ce que.}
\end{table}
...
\begin{frame}[c]{Towards predominant non-activation of the head}
    ...
    \begin{center}
        \includegraphics[width=10cm, height=6cm]{images/estcequeempty.png}
    \end{center}
...
\begin{frame}[c]{Towards predominant non-activation of the head}
    ...
    \textbf{\textsc{the decline of est-ce que}}
